import os
import argparse
from data_loder import data_loader_fusion_v5
...
def main(config):
    ...
    loader = data_loader_fusion_v5.get_loader("/media/data2/laixc/AI_DATA/expression_transfer/face12/fusion_face", config)
    G = FusionGenerater()
    ...
    for i in range(start_iters, 100000):
        ...
        if (i + 1) % n_critic == 0:
            ...
            l1_loss = torch.mean(maskfaces*torch.abs(faces_fake - target_fulls))
