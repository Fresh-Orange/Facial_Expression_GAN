import os
import argparse
from data_loder import data_loader_augment_color as data_loader_augment
        ...
        if (i + 1) % n_critic == 0:
            ...
            if (i + 1) % 24 == 0:
                with torch.no_grad():
                    ...
                    save_image(denorm(faces.data.cpu()), sample_path_face)

                    sample_path_face = os.path.join(sample_dir, '{}-image-rotate-face.jpg'.format(i + 1))
