...
class FaceDataset(data.Dataset):
    ...
    def preprocess(self):
        ...
        for sub_dir in os.listdir(self.face_dir):
            ...
            if 12000 > int(sub_dir) > 11000 and len(os.listdir(full_sub_dir)) != 8:#int(sub_dir) != 11027
                continue
            else:
                print("Reading {}".format(sub_dir))
                print(len(os.listdir(full_sub_dir)))

            if int(sub_dir) > 12000 and len(os.listdir(full_sub_dir)) != 8:
                print(len(os.listdir(full_sub_dir)))
                continue
            if 11000 > int(sub_dir) > 10000 and len(os.listdir(full_sub_dir)) != 8:
                print(len(os.listdir(full_sub_dir)))
                continue
