...
class FaceDataset(data.Dataset):
    def __init__(self, face_dir, keypoints_dir, transform, mode, config):
        ...
        self.rotate_transform.append(T.Resize((224, 224)))
        # self.rotate_transform.append(T.Pad((62, 62), fill=(255,255,255), padding_mode='constant'))
        # self.rotate_transform.append(T.RandomRotation(15))
        # self.rotate_transform.append(T.CenterCrop((224, 224)))
        self.rotate_transform.append(T.ToTensor())
        self.rotate_transform.append(T.Normalize(mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5)))
        self.rotate_transform = T.Compose(self.rotate_transform)
    ...
    def __getitem__(self, index):
        ...
        angle = random.choice([-15, -10, 0, 10, 15])
        rotate_faceimage = TF.resize(faceimage, (224, 224))
        rotate_faceimage = TF.pad(rotate_faceimage, padding=(62,62), fill=(255,255,255), padding_mode='constant')
        ...
        return self.transform(rotate_faceimage), self.transform(rotate_keypointimage), self.transform(faceimage), self.transform(keypointimage)
