...
class FaceDataset(data.Dataset):
    def __init__(self, face_dir, keypoints_dir, transform, mode, config):
        ...
        #self.rotate_transform.append(T.Pad((62, 62), padding_mode='edge'))
        #self.rotate_transform.append(T.RandomVerticalFlip(p=0.5))
        #self.rotate_transform.append(T.CenterCrop((224+32, 224+32)))
    ...
    def __getitem__(self, index):
        ...
        light = (random.random()/2 + 0.85)
        faceimage = TF.adjust_brightness(faceimage, light)
