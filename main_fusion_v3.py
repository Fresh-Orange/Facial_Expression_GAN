...
import data_loader_fusion_v3
from torch.backends import cudnn
import torch
from model import RealFakeDiscriminator, FeatureExtractNet, FusionGenerater
...
def main(config):
    ...
    for i in range(start_iters, 100000):
        ...
        fullfaces = torch.stack((fullfaces[0], fullfaces[0], fullfaces[0]))
