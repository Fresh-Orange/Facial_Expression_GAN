...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--lambda_C', type=float, default=10.0, help='weight for psnr loss')
        ...
        self.parser.add_argument('--use_test', action='store_true', help='use test data')
        self.parser.add_argument('--use_fashion', action='store_true', help='use fashion data')
        self.parser.add_argument('--use_re', action='store_true', help='use rebulid' )
