...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--data_list', type=str, default='/media/data2/zhangpz/ai_dancing/datasets/train_videos.json', help='data_list')
        ...
        self.parser.add_argument('--use_seg', action='store_true', help='use segmentation')
        self.parser.add_argument('--use_inverse_seg', action='store_true', help='use inverse segmentation')
        self.parser.add_argument('--with_D_MM', action='store_true', help='use segmentation')
